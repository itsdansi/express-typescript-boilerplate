...
import {
    Authorized, Body, Delete, Get, JsonController, OnUndefined, Param, Post, Put, QueryParams, Req
...
export class UserController {
    ...
    @Get('/search')
    @ResponseSchema(UserResponse, { isArray: true })
    public search(@QueryParams() queryParams: { search: string }): Promise<User[]> {
        return this.userService.search(queryParams.search);
    }
}
